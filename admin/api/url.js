const mod = {
  LOGIN: { url: "/api/user/login", method: "post", mock: false },
  LOGOUT: { url: "/api/user/logout", method: "post", mock: false },
  GET_USER: { url: "/api/user/info", method: "get", mock: false }, // mock: '/api/auth/v1/sys/user/:id'
  GET_DRAWER_MENU: {
  ...
  ORDER_CATEGORY: {
    ...
    method: "post",
    mock: false
  }, // mock: '/api/content//v1/category/order/:sourceId/back/:targetId'
  ADD_CATEGORY: {
    url: "/api/content/v1/category",
    method: "post",
    mock: false
  },
  GET_CATEGORY: {
    url: "/api/content/v1/category",
    method: "get",
    mock: "/api/content/v1/category/:id"
  },
  ...
  ARCHIVE_GET_CATEGORY: {
    url: "/api/content/v1/archive/category/list/",
    mock: false
  },
  ARCHIVE_ADD_CATEGORY: {
    url: "/api/content/v1/archive/add/to/category",
    mock: false
  },
  FETCH_TAG_LIST: {
    url: "/api/content/v1/tag/page",
    method: "get",
    mock: false
  },
  FETCH_CATEGORY_LIST: {
    url: "/api/content/v1/category/manage/page",
    method: "post",
    mock: false
  },
  BATCH_DEL_ARCHIVE: { url: "/api/content/v1/archive/batch", method: "delete" },
  FETCH_ARCHIVE_LIST: {
    url: "/api/content/v1/archive/manage/page",
    method: "post",
    mock: false
  },
  FILE_UPLOAD: {
    url: "/api/content/v1/file/upload",
    method: "post",
    mock: false
  },
  BATCH_FILE_UPLOAD: {
    url: "/api/content/v1/file/batch/upload",
    method: "post",
    mock: false
  },
